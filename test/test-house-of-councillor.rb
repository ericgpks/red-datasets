class HouseOfCouncillorTest < Test::Unit::TestCase
  ...
  sub_test_case(":in_house_group") do
    ...
    test("#each") do
      ...
      assert_equal([
                     13,
                     record(Date.parse("2026-08-12"),
                            "自由民主党・無所属の会",
                            "自民",
                            records.first.number_of_members_on,
                            101,
                            20,
                     ...
                     record(Date.parse("2026-08-12"),
                            "各派に属しない議員",
                            "無所属",
                            records.last.number_of_members_on,
                            6,
                            2,
                            Date.parse("2028-07-25"),
                            1,
    ...
    test("#each") do
      ...
      assert_equal([
                     ...
                     record("青木　愛",
                            ...
                            records.first.responsibility_on,
                     ...
                     record("渡辺　猛之",
                            ...
                            records.last.responsibility_on,
  ...
  sub_test_case(":question") do
    ...
    test("#each") do
      ...
      assert_equal([
                     ...
                     record(221,
                            112,
                            "皇室典範の改正による皇位継承及び養子制度の憲法問題等に関する質問主意書",
                            "小西　洋之",
                            1,
                            "https://www.sangiin.go.jp/japanese/joho1/kousei/syuisyo/221/syuh/s221112.htm",
                            "https://www.sangiin.go.jp/japanese/joho1/kousei/syuisyo/221/touh/t221112.htm",
                            "https://www.sangiin.go.jp/japanese/joho1/kousei/syuisyo/221/syup/s221112.pdf",
                            "https://www.sangiin.go.jp/japanese/joho1/kousei/syuisyo/221/toup/t221112.pdf",
                            "https://www.sangiin.go.jp/japanese/joho1/kousei/syuisyo/221/meisai/m221112.htm",
                            Date.parse("2026-07-24"),
                            Date.parse("2026-07-24"),
                            Date.parse("2026-08-04"),
                            "7月28日内閣から通知書受領（8月4日まで答弁延期）"),
                   ],
                   [
                     records.size,
                     records.first,
